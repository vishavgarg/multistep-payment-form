...
include 'dbConnect.php';
    ...
    $pageview = $_GET['getID']; 
	$selectproduct =mysqli_query($db_conn, "select * from events where id = '$pageview' ");
...
if(!empty($_GET['session_id'])){
    ...
    $sql = "SELECT * FROM stripe_orders WHERE checkout_session_id = '".$session_id."'";
        ...
        if(empty($api_error) && $checkout_session){
            ...
            if(empty($api_error) && $intent){ 
                ...
                if($intent->status == 'succeeded'){
					...
					$sql = "INSERT INTO stripe_orders(name,email,item_name,item_number,item_price,item_price_currency,paid_amount,paid_amount_currency,txn_id,payment_status,checkout_session_id,created,modified) VALUES('".$name."','".$email."','".$rowproduct['name']."','".$rowproduct['id']."','".$rowproduct['price']."','"."USD"."','".$paidAmount."','".$paidCurrency."','".$transactionID."','".$paymentStatus."','".$session_id."',NOW(),NOW())"; 
...
<body class="App">
	...
	<div class="wrapper">
		<?php if(!empty($paymentID)){ ?>
			...
			<p><b>Price:</b> <?php echo $rowproduct['price'].' '."USD"; ?></p>
		<?php } ?>
